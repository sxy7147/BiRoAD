...
from rlbench.backend.const import (
    EPISODES_FOLDER, LOW_DIM_PICKLE, VARIATIONS_ALL_FOLDER,
    VARIATIONS_FOLDER, VARIATION_NUMBER,
)


def get_stored_demos(amount=1,
                     dataset_root='data/raw/peract2/test',
                     variation_number=0,
                     task_name='bimanual_handover_item_easy_random',
